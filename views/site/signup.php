...
$this->params['meta_description'] = 'Daftar akun baru untuk mengakses aplikasi Yii2.';
$this->params['meta_keywords'] = 'yii, yii2, signup, register, daftar';
$htmlIcon = <<<HTML
                ...
                <div class="d-flex flex-column justify-content-between p-4 p-lg-5 w-100">
                    ...
                    <div>
                        ...
                        <p class="opacity-75 mb-0 login-brand-text">
                            Buat akun baru untuk mulai menggunakan aplikasi ini.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-7">
                <div class="p-4 p-lg-5">
                    <div class="text-center mb-4">
                        ...
                        <p class="text-body-secondary small">Isi data di bawah untuk membuat akun</p>
                    </div>
                    ...
                    <div class="text-body-secondary text-center mt-3 small">
                        Sudah punya akun?
                        <?= Html::a('Login di sini', ['site/login']) ?>
                    </div>
